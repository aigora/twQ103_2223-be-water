...
int analizardatos (){
    ...
    i=0;
    contador=0;
    /*while (fscanf(fentrada, "%s %f %d %d %d", fuentes[i].nombre, &fuentes[i].pH, &fuentes[i].conductividad, &fuentes[i].turbidez, &fuentes[i].coliformes) != EOF) {
        printf("%s %.2f %d %d %d\n", fuentes[i].nombre, fuentes[i].pH, fuentes[i].conductividad, fuentes[i].turbidez, fuentes[i].coliformes);
        i++;
        contador++;                
    }*/
     while (fgets(buffer, 1024, fentrada)) {
        sscanf(buffer, "%s %f %d %d %d", fuentes[i].nombre, &fuentes[i].pH, &fuentes[i].conductividad, &fuentes[i].turbidez, &fuentes[i].coliformes);
        printf("%s %.2f %d %d %d\n", fuentes[i].nombre, fuentes[i].pH, fuentes[i].conductividad, fuentes[i].turbidez, fuentes[i].coliformes);
        i++;
        contador++;
    }
